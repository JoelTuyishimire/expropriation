...
@section("title","System Top-ups Report")
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5"> System Top-ups Report</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted"> System Top-ups Report</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card-body">
                    <div class="accordion accordion-toggle-arrow mb-3" id="accordionExample1">
                        <div class="card">
                            ...
                            <div id="application-payment-section" class="collapse show {{request()->fullUrl()==route("admin.all.transactions")?'':'show'}}" data-parent="#accordionExample1" style="">
                                <div class="p-5">
                                    <form method="get" action="{{route('admin.system-top-ups.report')}}" id="search-form" >
                                        <div class="row">
...
@section('scripts')
    ...
    <script>
        ...
        $('.nav-system-report').addClass('menu-item-active');
